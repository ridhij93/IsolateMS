...
public class CollectionServer implements Entity, HasFeaturedImage, Localized, Child, HasAddons {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.id, other.getId()) && Objects.equal(this.parentId, other.getParentId()) && Objects.equal(this.title, other.getTitle()) && Objects.equal(this.slug, other.getSlug()) && Objects.equal(this.description, other.getDescription());
    }
