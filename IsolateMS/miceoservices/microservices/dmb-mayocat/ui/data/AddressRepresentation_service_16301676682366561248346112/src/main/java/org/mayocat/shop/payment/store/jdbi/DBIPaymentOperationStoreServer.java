 ...
 */
@Component
public class DBIPaymentOperationStoreServer implements PaymentOperationStore, Initializable {
    ...
    @Override
    public PaymentOperation create(@Valid PaymentOperation operation) throws EntityAlreadyExistsException, InvalidEntityException {
    ...
    public void setDao(PaymentOperationDAO dao) {
        this.dao = dao;
    }

    public PaymentOperationDAO getDao() {
        return dao;
    }
}
