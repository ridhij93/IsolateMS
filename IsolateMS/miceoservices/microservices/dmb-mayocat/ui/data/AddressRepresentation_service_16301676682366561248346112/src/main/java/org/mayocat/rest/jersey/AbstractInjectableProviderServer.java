 ...
 */
public abstract class AbstractInjectableProviderServer<E> extends AbstractHttpContextInjectable<E> implements InjectableProvider<Context, Type> {

    private final Type t;

    public AbstractInjectableProviderServer(Type t) {
        this.t = t;
    }
