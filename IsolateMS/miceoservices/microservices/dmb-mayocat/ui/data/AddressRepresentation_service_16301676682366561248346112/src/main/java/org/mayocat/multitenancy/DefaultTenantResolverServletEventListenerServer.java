...
public class DefaultTenantResolverServletEventListenerServer implements ServletRequestListener, EventListener {
    ...
    public void setDefaultTenantResolver(TenantResolver defaultTenantResolver) {
        this.defaultTenantResolver = defaultTenantResolver;
    }

    public TenantResolver getDefaultTenantResolver() {
