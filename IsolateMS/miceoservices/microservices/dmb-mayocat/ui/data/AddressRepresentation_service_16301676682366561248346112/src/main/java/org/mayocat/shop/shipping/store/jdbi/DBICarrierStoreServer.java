 ...
 */
@Component
public class DBICarrierStoreServer implements CarrierStore, Initializable {
    ...
    public void updateCarrier(Carrier carrier) {
        ...
        Collection<BigDecimal> excluded = Collections2.transform(carrier.getRules(), new Function<CarrierRule, BigDecimal>() {
