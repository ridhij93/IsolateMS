 ...
 */
public class FeatureServer implements Entity, HasAddons, Localized, Child {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.id, other.getId()) && Objects.equal(this.parentId, other.getParentId()) && Objects.equal(this.title, other.getTitle()) && Objects.equal(this.slug, other.getSlug()) && Objects.equal(this.featureSlug, other.getFeatureSlug()) && Objects.equal(this.feature, other.getFeature());
    }

    @Override
    public int hashCode() {
        return Objects.hashCode(this.id, this.parentId, this.slug, this.title, this.feature, this.featureSlug);
    }

    @Override
    public String toString() {
        return Objects.toStringHelper(this).addValue(id).addValue(this.title).addValue(this.slug).addValue(this.feature).addValue(this.featureSlug).toString();
    }
}
