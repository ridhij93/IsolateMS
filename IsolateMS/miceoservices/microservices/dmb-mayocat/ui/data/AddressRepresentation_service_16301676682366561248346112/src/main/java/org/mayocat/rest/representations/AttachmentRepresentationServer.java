 ...
 */
public class AttachmentRepresentationServer extends EntityReferenceRepresentation {
    ...
    public AttachmentRepresentationServer() {
        // No-arg constructor required for Jackson deserialization
        super();
    }

    public AttachmentRepresentationServer(Attachment attachment) {
     ...
     */
    public AttachmentRepresentationServer(Attachment attachment, String uri, FileRepresentation file) {
    ...
    public void setLocalizedVersions(Map<Locale, Map<String, Object>> localizedVersions) {
