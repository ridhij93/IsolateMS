 ...
 */
public class JailedPathJtwigResourceServer implements JtwigResource {

    private Path jail;

    private Path resourcePath;

    public JailedPathJtwigResourceServer(Path jail, Path resourcePath) {
