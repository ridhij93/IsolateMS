...
public class DBIEntityListStoreServer extends DBIEntityStore implements EntityListStore, Initializable {
    ...
    public static String getENTITY_LIST_TABLE_NAME() {
        return ENTITY_LIST_TABLE_NAME;
    }

    public void setDao(EntityListDAO dao) {
        this.dao = dao;
    }

    public EntityListDAO getDao() {
        return dao;
    }
