...
@Component("basic")
public class BasicAuthenticatorServer implements Authenticator {
    ...
    public boolean respondTo(String headerName, String headerValue) {
        if (headerName.equalsIgnoreCase(HttpHeaders.getAUTHORIZATION())) {
    ...
    public Optional<User> verify(String value, Tenant tenant) {
        ...
        if (space > 0) {
            final String decoded = B64Code.decode(value.substring(space + 1), StringUtil.get__ISO_8859_1());
