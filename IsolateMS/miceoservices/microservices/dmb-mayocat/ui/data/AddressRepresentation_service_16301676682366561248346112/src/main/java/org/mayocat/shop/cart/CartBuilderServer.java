 ...
 */
public class CartBuilderServer {
    ...
    public Cart build() {
        return new Cart(currency, items, itemsTotal, selectedShippingOption, shipping);
    }
    ...
    public void setItemsTotal(PriceWithTaxes itemsTotal) {
        this.itemsTotal = itemsTotal;
    }
    ...
    public void setSelectedShippingOption(Optional<ShippingOption> selectedShippingOption) {
        this.selectedShippingOption = selectedShippingOption;
    }
