...
public class DBIMarketplaceProductStoreServer implements MarketplaceProductStore, Initializable {
    ...
    public List<Product> findAllNotVariants(Integer number, Integer offset) {
        return AddonsHelper.withAddons(this.marketplaceProductDAO.findAllNotVariants(number, offset, "product.title"), this.marketplaceProductDAO);
    }
    ...
    public List<Product> findAllNotVariants(Integer number, Integer offset, Order order) {
        ...
        return AddonsHelper.withAddons(this.marketplaceProductDAO.findAllNotVariants(number, offset, orderby), this.marketplaceProductDAO);
    }
    ...
    public List<Product> findAllWithTitleLike(String title, Integer number, Integer offset) {
        return AddonsHelper.withAddons(this.marketplaceProductDAO.findAllWithTitleLike(title, number, offset), this.marketplaceProductDAO);
    }
    ...
    public List<Product> findAllOnShelfWithTitleLike(String title, Integer number, Integer offset) {
        return AddonsHelper.withAddons(this.marketplaceProductDAO.findAllOnShelfWithTitleLike(title, number, offset), this.marketplaceProductDAO);
    }
    ...
    public List<Product> findAllForTenant(Tenant tenant, Integer number, Integer offset) {
        return AddonsHelper.withAddons(this.marketplaceProductDAO.findAllForTenant(tenant, number, offset), this.marketplaceProductDAO);
    }

    @Override
    public List<Product> findAllForTenantOnShelf(Tenant tenant, Integer number, Integer offset) {
        return AddonsHelper.withAddons(this.marketplaceProductDAO.findAllForTenantOnShelf(tenant, number, offset), this.marketplaceProductDAO);
    }
