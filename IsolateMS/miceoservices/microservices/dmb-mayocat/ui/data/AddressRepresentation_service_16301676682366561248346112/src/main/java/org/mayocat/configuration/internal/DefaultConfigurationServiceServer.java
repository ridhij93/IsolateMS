 ...
 */
@Component
public class DefaultConfigurationServiceServer implements ConfigurationService {
    ...
    public void updateSettings(Map<String, Serializable> data) {
        ...
        TenantConfiguration configuration = new TenantConfiguration(TenantConfiguration.getCURRENT_VERSION(), result.getResult());
    ...
    public void setGestaltConfigurationSources(Map<String, GestaltConfigurationSource> gestaltConfigurationSources) {
        this.gestaltConfigurationSources = gestaltConfigurationSources;
    }

    public Map<String, GestaltConfigurationSource> getGestaltConfigurationSources() {
        return gestaltConfigurationSources;
    }
    ...
    public void setExposedPlatformSettingsAsJson(Map<String, Serializable> exposedPlatformSettingsAsJson) {
        this.exposedPlatformSettingsAsJson = exposedPlatformSettingsAsJson;
    }
}
