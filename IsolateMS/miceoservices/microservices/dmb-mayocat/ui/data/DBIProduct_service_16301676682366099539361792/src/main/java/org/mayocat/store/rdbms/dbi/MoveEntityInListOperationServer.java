...
public class MoveEntityInListOperationServer<E extends Entity> {
    ...
    public MoveEntityInListOperationServer(List<E> entities, String fromSlug, String toSlug, HasOrderedCollections.RelativePosition relativePosition) throws InvalidMoveOperation {
        ...
        for (E entity : this.entities) {
            ...
            if (toSlug.equals(entity.getSlug())) {
                if (from == -1) {
                    ...
                    to = relativePosition.equals(HasOrderedCollections.getRelativePosition().AFTER) ? i + 1 : i;
                } else {
                    // From is already found : this position or up the list
                    to = relativePosition.equals(HasOrderedCollections.getRelativePosition().AFTER) ? i : i - 1;
                }
            }
            i++;
        }
