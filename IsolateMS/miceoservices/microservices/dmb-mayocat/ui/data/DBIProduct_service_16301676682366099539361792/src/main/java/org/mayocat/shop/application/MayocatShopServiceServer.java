...
public class MayocatShopServiceServer extends AbstractService<MayocatShopSettings> {
    ...
    public void initialize(Bootstrap<MayocatShopSettings> bootstrap) {
        ...
        bootstrap.addBundle(new FlywayBundle<MayocatShopSettings>() {
            ...
            @Override
            public DataSourceFactory getDataSourceFactory(MayocatShopSettings mayocatShopSettings) {
    ...
    private void registerDBIFactoryComponent(Environment environment, MayocatShopSettings configuration) throws ClassNotFoundException, ComponentRepositoryException {
        ...
        if (configuration.getDevelopmentEnvironment().isEnabled() && configuration.getDevelopmentEnvironment().isLogDatabaseRequests()) {
    ...
    public static String getCOMMON_PATH() {
        return COMMON_PATH;
    }

    public static String getMANAGER_PATH() {
        return MANAGER_PATH;
    }

    public static String getADMIN_UI_PATH() {
        return ADMIN_UI_PATH;
    }

    public static String getCLIENT_RESOURCE_PATH() {
        return CLIENT_RESOURCE_PATH;
    }
