 ...
 */
@PluralForm("news")
public class ArticleServer implements Entity, HasAddons, HasModel, HasFeaturedImage {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.id, other.getId()) && Objects.equal(this.title, other.getTitle()) && Objects.equal(this.slug, other.getSlug()) && Objects.equal(this.content, other.getContent());
    }
