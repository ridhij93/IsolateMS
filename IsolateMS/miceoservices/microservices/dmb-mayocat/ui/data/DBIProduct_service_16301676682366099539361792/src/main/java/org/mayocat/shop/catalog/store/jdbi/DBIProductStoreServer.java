...
public class DBIProductStoreServer extends DBIEntityStore implements ProductStore, Initializable {
    ...
    public void moveProduct(String productToMove, String productToMoveRelativeTo, HasOrderedCollections.RelativePosition relativePosition) throws InvalidMoveOperation {
        ...
        MoveEntityInListOperation<Product> moveOp = new MoveEntityInListOperation<>(allProducts, productToMove, productToMoveRelativeTo, relativePosition);
        if (moveOp.hasMoved()) {
    ...
    public List<Product> findAll(Integer number, Integer offset) {
        return AddonsHelper.withAddons(this.dao.findAll(PRODUCT_TABLE_NAME, PRODUCT_POSITION, getTenant(), number, offset), this.dao);
    }
    ...
    public static String getPRODUCT_POSITION() {
        return PRODUCT_POSITION;
    }

    public static String getPRODUCT_TABLE_NAME() {
        return PRODUCT_TABLE_NAME;
    }

    public static String getFEATURE_TABLE_NAME() {
