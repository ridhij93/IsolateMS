 ...
 */
public class HomePageServer implements Entity, HasAddons, Localized {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.id, other.getId()) && Objects.equal(this.slug, other.getSlug()) && Objects.equal(this.addons, other.getAddons());
    }

    @Override
    public int hashCode() {
        return Objects.hashCode(this.slug, this.addons);
    }

    @Override
    public String toString() {
        return Objects.toStringHelper(this).addValue(id).addValue(this.slug).toString();
    }
}
