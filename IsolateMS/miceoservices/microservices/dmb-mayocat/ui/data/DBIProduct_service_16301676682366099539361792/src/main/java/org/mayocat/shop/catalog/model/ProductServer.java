...
@Index
public class ProductServer implements Entity, HasAddons, HasModel, HasFeaturedImage, Taxable, Localized, HasType, Child {
    ...
    public Optional<String> getVatRateId() {
        return taxes.containsKey(VAT) ? Optional.fromNullable(taxes.get(VAT)) : Optional.<String>absent();
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.id, other.getId()) && Objects.equal(this.title, other.getTitle()) && Objects.equal(this.slug, other.getSlug()) && Objects.equal(this.onShelf, other.getOnShelf()) && Objects.equal(this.price, other.getPrice()) && Objects.equal(this.taxes, other.getTaxes()) && Objects.equal(this.stock, other.getStock()) && Objects.equal(this.weight, other.getWeight()) && Objects.equal(this.featuredImageId, other.getFeaturedImageId());
    }

    @Override
    public int hashCode() {
        return Objects.hashCode(this.slug, this.title, this.onShelf, this.price, this.taxes, this.stock, this.featuredImageId, this.weight);
    }

    @Override
    public String toString() {
        return Objects.toStringHelper(this).addValue(id).addValue(this.title).addValue(this.slug).toString();
    }
