 ...
 */
@Component
public class DefaultEntityIndexDocumentPurveyorServer extends AbstractGenericEntityIndexDocumentPurveyor implements EntityIndexDocumentPurveyor {
    ...
    public Map<String, Object> purveyDocument(Entity entity, Tenant tenant) {
        ...
        try {
            EntityIndexDocumentPurveyor indexHandler = this.componentManager.getInstance(indexDocumentPurveyorOf(entity.getClass()).getType());
