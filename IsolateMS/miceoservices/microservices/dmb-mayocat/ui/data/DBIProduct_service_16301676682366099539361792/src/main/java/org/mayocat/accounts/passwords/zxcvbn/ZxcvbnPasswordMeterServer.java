 ...
 */
public class ZxcvbnPasswordMeterServer {
    ...
    public PasswordStrength getStrength(String password) {
        ...
        String inputsAsArrayString = '[' + Joiner.on(",").join(FluentIterable.from(inputs).transform(new Function<String, String>() {
        ...
        context.evaluateString(scope, "var result = zxcvbn(password, " + inputsAsArrayString + ");" + "writer.write(JSON.stringify(result))", "eval-zxcvbn.js", 1, null);
    ...
    public void setGlobal(Scriptable global) {
        this.global = global;
    }
    ...
    public void setZxcvbnFileName(String zxcvbnFileName) {
        this.zxcvbnFileName = zxcvbnFileName;
    }

    public String getZxcvbnFileName() {
        return zxcvbnFileName;
    }

    public void setZxcvbnFilePath(String zxcvbnFilePath) {
        this.zxcvbnFilePath = zxcvbnFilePath;
    }

    public String getZxcvbnFilePath() {
        return zxcvbnFilePath;
    }
