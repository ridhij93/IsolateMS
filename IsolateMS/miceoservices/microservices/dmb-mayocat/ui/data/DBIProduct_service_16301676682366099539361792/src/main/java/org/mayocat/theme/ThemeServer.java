...
public class ThemeServer {
    ...
    public ThemeServer(Path path, ThemeDefinition definition) {
        this(path, definition, null, Type.FILE_SYSTEM);
    }

    public ThemeServer(Path path, ThemeDefinition definition, Type type) {
        this(path, definition, null, type);
    }

    public ThemeServer(Path path, ThemeDefinition definition, Theme parent) {
        this(path, definition, parent, Type.FILE_SYSTEM);
    }

    public ThemeServer(Path path, ThemeDefinition definition, Theme parent, Type type) {
        this.path = path;
    ...
    public ThemeServer(Path path, ThemeDefinition definition, Theme parent, Type type, boolean isValidDefinition) {
        this.path = path;
        this.definition = definition;
        this.parent = parent;
        this.type = type;
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(this.path, this.parent);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equal(this.path, other.getPath()) && Objects.equal(this.parent, other.getParent());
    }
    ...
    public void setIsTenantOwnTheme(boolean isTenantOwnTheme) {
        this.isTenantOwnTheme = isTenantOwnTheme;
    }

    public boolean getIsTenantOwnTheme() {
        return isTenantOwnTheme;
    }

    public void setIsValidDefinition(boolean isValidDefinition) {
        this.isValidDefinition = isValidDefinition;
    }

    public boolean getIsValidDefinition() {
        return isValidDefinition;
    }
}
