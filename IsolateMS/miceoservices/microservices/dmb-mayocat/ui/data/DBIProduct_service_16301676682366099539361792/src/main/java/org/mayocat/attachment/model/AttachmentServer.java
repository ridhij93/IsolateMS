...
public class AttachmentServer implements Entity, Child, Localized {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.id, other.getId()) && Objects.equal(this.title, other.getTitle()) && Objects.equal(this.slug, other.getSlug()) && Objects.equal(this.extension, other.getExtension()) && Objects.equal(this.description, other.getDescription()) && Objects.equal(this.parentId, other.getParentId()) && Objects.equal(this.metadata, other.getMetadata());
    }
