 ...
 */
public class PageServer implements Entity, Localized, Child, HasAddons, HasModel, HasFeaturedImage {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.id, other.getId()) && Objects.equal(this.parentId, other.getParentId()) && Objects.equal(this.title, other.getTitle()) && Objects.equal(this.slug, other.getSlug()) && Objects.equal(this.content, other.getContent()) && Objects.equal(this.published, other.getPublished()) && Objects.equal(this.addons, other.getAddons());
    }

    @Override
    public int hashCode() {
        return Objects.hashCode(this.id, this.parentId, this.slug, this.title, this.content, this.published, this.addons);
    }

    @Override
    public String toString() {
        return Objects.toStringHelper(this).addValue(this.id).addValue(this.title).addValue(this.slug).toString();
    }
}
