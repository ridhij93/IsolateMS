...
public class DBITenantStoreServer implements TenantStore, Initializable {
    ...
    public void updateConfiguration(TenantConfiguration configuration) {
        try {
            this.dao.updateConfiguration(getTenant(), configuration.getVersion(), convertConfigurationToJSON(configuration));
        } catch (JsonProcessingException e) {
    ...
    public static String getTENANT_TABLE_NAME() {
    ...
    public void setDao(TenantDAO dao) {
        this.dao = dao;
    }
