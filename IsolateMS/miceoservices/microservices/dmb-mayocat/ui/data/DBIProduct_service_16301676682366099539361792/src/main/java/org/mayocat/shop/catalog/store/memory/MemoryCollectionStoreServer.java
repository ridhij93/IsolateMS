 ...
 */
@Component("memory")
public class MemoryCollectionStoreServer extends AbstractPositionedEntityMemoryStore<Collection, CollectionPositionedEntity> implements CollectionStore {
