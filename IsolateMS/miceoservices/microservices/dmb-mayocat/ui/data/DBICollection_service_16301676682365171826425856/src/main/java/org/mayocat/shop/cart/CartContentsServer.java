 ...
 */
public class CartContentsServer {
    ...
    public CartContentsServer(Currency currency) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.items, other.getItems()) && Objects.equal(this.currency, other.getCurrency()) && Objects.equal(this.selectedShippingOption, other.getSelectedShippingOption());
    }
