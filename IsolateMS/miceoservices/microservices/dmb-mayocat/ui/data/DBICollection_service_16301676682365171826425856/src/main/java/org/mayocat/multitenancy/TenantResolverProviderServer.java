...
@Singleton
@Component
public class TenantResolverProviderServer implements Provider<TenantResolver> {
    ...
    public TenantResolver get() {
        try {
            ...
            try {
                this.logger.error("Failed to lookup instance of TenantResolver with hint [{}], trying default implementation", this.configuration.getResolver());
    ...
    public void setConfiguration(MultitenancySettings configuration) {
        this.configuration = configuration;
    }

    public MultitenancySettings getConfiguration() {
