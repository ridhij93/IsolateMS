 ...
 */
@Component
public class DefaultEntityURLFactoryServer extends AbstractGenericEntityURLFactory implements EntityURLFactory {
    ...
    public URL create(Entity entity, Tenant tenant, URLType type) {
        ...
        try {
            EntityURLFactory urlFactory = this.componentManager.getInstance(entityURLFactoryOf(entity.getClass()).getType());
            if (urlFactory != null) {
