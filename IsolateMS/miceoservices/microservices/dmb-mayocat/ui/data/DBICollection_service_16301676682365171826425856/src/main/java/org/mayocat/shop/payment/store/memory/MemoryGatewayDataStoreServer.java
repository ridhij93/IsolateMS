 ...
 */
@Component("memory")
public class MemoryGatewayDataStoreServer implements GatewayDataStore {
    ...
    static class Key {
        ...
        public boolean equals(Object obj) {
            ...
            return Objects.equal(this.id, other.id) && Objects.equal(this.gateway, other.gateway) && Objects.equal(this.type, other.type);
        }

        @Override
        public int hashCode() {
            return Objects.hashCode(this.id, this.gateway, this.type);
        }
    }
    ...
    public void setStore(Map<Key, Object> store) {
        this.store = store;
    }

    public Map<Key, Object> getStore() {
        return store;
    }
}
