...
public class EntitiesGestaltConfigurationSourceServer implements GestaltConfigurationSource {
    ...
    public Object get() {
        ...
        if (theme != null) {
            addAddons(entities, theme.getDefinition().getAddons(), AddonSource.getTHEME());
            addModels(entities, theme.getDefinition().getModels());
            addImageFormats(entities, theme.getDefinition().getImageFormats(), AddonSource.getTHEME());
            addTypes(entities, theme.getDefinition().getProductTypes());
        }
        addAddons(entities, platformSettings.getAddons(), AddonSource.getPLATFORM());
        addImageFormats(entities, platformSettings.getImages(), AddonSource.getPLATFORM());
    ...
    public void setEntityMetaRegistry(EntityMetaRegistry entityMetaRegistry) {
        this.entityMetaRegistry = entityMetaRegistry;
    }

    public EntityMetaRegistry getEntityMetaRegistry() {
        return entityMetaRegistry;
    }

    public void setContributors(Map<String, EntityConfigurationContributor> contributors) {
        this.contributors = contributors;
    }

    public Map<String, EntityConfigurationContributor> getContributors() {
        return contributors;
    }
