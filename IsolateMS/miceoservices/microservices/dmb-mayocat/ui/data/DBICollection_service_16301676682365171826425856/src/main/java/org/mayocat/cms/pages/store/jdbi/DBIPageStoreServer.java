...
public class DBIPageStoreServer extends DBIEntityStore implements PageStore, Initializable {
    ...
    public static String getPAGE_POSITION() {
        return PAGE_POSITION;
    }

    public static String getPAGE_TABLE_NAME() {
