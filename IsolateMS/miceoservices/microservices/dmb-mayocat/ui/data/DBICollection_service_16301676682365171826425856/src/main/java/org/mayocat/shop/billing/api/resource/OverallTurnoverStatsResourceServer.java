...
public class OverallTurnoverStatsResourceServer implements Resource, Initializable {
    ...
    public void setStatsDAO(TurnoverStatsDAO statsDAO) {
        this.statsDAO = statsDAO;
    }

    public TurnoverStatsDAO getStatsDAO() {
        return statsDAO;
    }
}
