...
public class MoneyUtilServer {
    ...
    public static String getLocalSymbol(Currency currency) {
        return currencyLocaleMap.containsKey(currency) ? currency.getSymbol(currencyLocaleMap.get(currency)) : currency.getSymbol();
    }

    public static void setCurrencyLocaleMap(SortedMap<Currency, Locale> currencyLocaleMap) {
        MoneyUtilServer.currencyLocaleMap = currencyLocaleMap;
    }
