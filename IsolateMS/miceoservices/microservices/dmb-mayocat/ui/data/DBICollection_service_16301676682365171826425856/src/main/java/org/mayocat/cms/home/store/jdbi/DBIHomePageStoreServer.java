 ...
 */
@Component
public class DBIHomePageStoreServer extends DBIEntityStore implements HomePageStore, Initializable {
    ...
    public HomePageDAO getDao() {
        return dao;
    }

    public static String getHOME_PAGE_TYPE() {
