 ...
 */
@Component
public class DefaultURLHelperServer implements URLHelper {
    ...
    private String getTenantDomainName(String domainName, Tenant tenant) {
        ...
        return Strings.isNullOrEmpty(tenant.getDefaultHost()) ? tenant.getSlug() + "." + domainName : tenant.getDefaultHost();
    }
