...
public class TenantServer implements Entity, HasAddons, HasFeaturedImage {
    ...
    public TenantServer(String slug, TenantConfiguration configuration) {
        setSlug(slug);
        this.configuration = configuration;
    }

    public TenantServer(UUID id, String slug, TenantConfiguration configuration) {
        setId(id);
        setSlug(slug);
        this.configuration = configuration;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equal(this.slug, other.getSlug());
    }
