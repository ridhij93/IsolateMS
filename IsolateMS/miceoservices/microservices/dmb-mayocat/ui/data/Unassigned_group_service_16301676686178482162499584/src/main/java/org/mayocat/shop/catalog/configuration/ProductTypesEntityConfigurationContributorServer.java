...
public class ProductTypesEntityConfigurationContributorServer implements EntityConfigurationContributor {
    ...
    public void contribute(Map<String, Object> configuration) {
        ...
        ((Map<String, TypeDefinition>) configuration.get("types")).putAll(catalogSettings.getProductsSettings().getTypes());
    }
