...
public abstract class ProductDAOServer implements EntityDAO<Product>, Transactional<ProductDAO>, PositionedDAO<Product>, AddonsDAO<Product>, LocalizationDAO<Product> {
