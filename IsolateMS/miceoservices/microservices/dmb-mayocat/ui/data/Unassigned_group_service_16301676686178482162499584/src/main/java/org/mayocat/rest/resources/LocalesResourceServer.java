...
public class LocalesResourceServer implements Resource {
    ...
    public Response getLocales() {
        if (localesRepresentations == null) {
            ...
            Ordering<LocaleRepresentation> nameOrdering = Ordering.natural().onResultOf(new Function<LocaleRepresentation, String>() {
    ...
    public void setLocalesRepresentations(Set<LocaleRepresentation> localesRepresentations) {
        this.localesRepresentations = localesRepresentations;
    }

    public Set<LocaleRepresentation> getLocalesRepresentations() {
        return localesRepresentations;
    }
}
