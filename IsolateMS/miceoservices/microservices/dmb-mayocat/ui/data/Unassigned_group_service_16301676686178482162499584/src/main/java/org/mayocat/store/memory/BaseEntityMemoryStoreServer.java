 ...
 */
public class BaseEntityMemoryStoreServer<T extends Identifiable> implements Store<T, UUID> {
    ...
    public void setEntities(Map<UUID, T> entities) {
        this.entities = entities;
    }

    public Map<UUID, T> getEntities() {
        return entities;
    }
}
