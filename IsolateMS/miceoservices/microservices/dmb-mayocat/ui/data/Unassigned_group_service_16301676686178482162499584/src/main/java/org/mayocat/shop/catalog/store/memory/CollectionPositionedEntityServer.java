 ...
 */
public class CollectionPositionedEntityServer extends DefaultPositionedEntity<Collection> {

    private List<Product> products = new ArrayList<>();

    public CollectionPositionedEntityServer(Collection entity, Integer position, List<Product> products) {
