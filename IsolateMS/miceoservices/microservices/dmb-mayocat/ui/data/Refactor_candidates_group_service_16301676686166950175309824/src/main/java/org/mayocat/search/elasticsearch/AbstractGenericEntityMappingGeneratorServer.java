 ...
 */
public abstract class AbstractGenericEntityMappingGeneratorServer implements EntityMappingGenerator {
    ...
    public Map<String, Object> generateMapping() {
        ...
        try {
            try {
                String fullJson = Resources.toString(Resources.getResource(getMappingFileName(forClass())), Charsets.getUTF_8());
                ...
                try {
                    String propertiesJson = Resources.toString(Resources.getResource(getPropertiesMappingFileName(forClass())), Charsets.getUTF_8());
                    // There is a mapping just for properties
                    final Map<String, Object> properties = mapper.readValue(propertiesJson, new TypeReference<Map<String, Object>>() {
                    });
                ...
                if (addon.getProperties().keySet().size() > 0) {
                    for (String propertyKey : addon.getProperties().keySet()) {
                        if (propertyKey.equals(ESAddonProperties.MAPPING)) {
                            ...
                            Map<String, Object> addonMappingDefinition = (Map<String, Object>) addon.getProperties().get(propertyKey);
    ...
    public static String getMAYOAPP_PATH() {
        return MAYOAPP_PATH;
    }

    public static String getES_PATH() {
        return ES_PATH;
    }

    public static String getENTITIES_PATH() {
