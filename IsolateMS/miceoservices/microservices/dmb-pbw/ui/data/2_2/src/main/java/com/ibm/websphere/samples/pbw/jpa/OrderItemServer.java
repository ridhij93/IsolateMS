...
public class OrderItemServer {
    ...
    public OrderItemServer() {
    }

    public OrderItemServer(Inventory inv) {
    ...
    public OrderItemServer(Order order, String orderID, Inventory inv, java.lang.String name, java.lang.String pkginfo, float price, float cost, int quantity, int category, java.lang.String sellDate) {
