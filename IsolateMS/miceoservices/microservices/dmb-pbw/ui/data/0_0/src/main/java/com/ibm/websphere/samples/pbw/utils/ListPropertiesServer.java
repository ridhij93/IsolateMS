 ...
 *  Utility class.
 */
public class ListPropertiesServer extends Properties {
    ...
    public void setListProps(Hashtable<String, Vector<String>> listProps) {
        this.listProps = listProps;
    }

    public Hashtable<String, Vector<String>> getListProps() {
        return listProps;
    }
}
