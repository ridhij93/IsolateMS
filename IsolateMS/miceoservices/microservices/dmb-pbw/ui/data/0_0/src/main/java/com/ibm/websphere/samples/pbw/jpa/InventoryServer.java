...
public class InventoryServer implements Cloneable, java.io.Serializable {
     ...
     */
    public InventoryServer(String key, String name, String heading, String desc, String pkginfo, String image, float price, float cost, int quantity, int category, String notes, boolean isPublic) {
     ...
     */
    public InventoryServer(Inventory item) {
    ...
    public static int getDEFAULT_MINTHRESHOLD() {
        return DEFAULT_MINTHRESHOLD;
    }

    public static int getDEFAULT_MAXTHRESHOLD() {
        return DEFAULT_MAXTHRESHOLD;
    }
