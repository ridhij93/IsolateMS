...
public class BackOrderServer {
    ...
    public BackOrderServer() {
    }

    public BackOrderServer(String backOrderID) {
        setBackOrderID(backOrderID);
    }

    public BackOrderServer(Inventory inventory, int quantity) {
        this.setInventory(inventory);
        this.setQuantity(quantity);
        this.setStatus(Util.getSTATUS_ORDERSTOCK());
    ...
    public void increateQuantity(int delta) {
        if (!(status.equals(Util.getSTATUS_ORDERSTOCK()))) {
