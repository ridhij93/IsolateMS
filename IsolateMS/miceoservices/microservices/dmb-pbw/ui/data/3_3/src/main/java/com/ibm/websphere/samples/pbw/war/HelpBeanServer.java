 ...
 */
@Named("help")
public class HelpBeanServer implements Serializable {
    ...
    public void setRdb(ResetDBBean rdb) {
        this.rdb = rdb;
    }

    public ResetDBBean getRdb() {
        return rdb;
    }

    public static String getACTION_HELP() {
        return ACTION_HELP;
    }

    public static String getACTION_HOME() {
        return ACTION_HOME;
    }
}
