...
@SessionScoped
public class ShoppingBeanServer implements Serializable {
    ...
    public String performCart() {
        ...
        return ShoppingBean.getACTION_CART();
    }
    ...
    public String performProductDetail() {
        ...
        return ShoppingBean.getACTION_PRODUCT();
    }
    ...
    public String performShopping() {
        ...
        try {
            ...
            if (this.products != null) {
                ...
                return ShoppingBean.getACTION_SHOPPING();
            }
        }
