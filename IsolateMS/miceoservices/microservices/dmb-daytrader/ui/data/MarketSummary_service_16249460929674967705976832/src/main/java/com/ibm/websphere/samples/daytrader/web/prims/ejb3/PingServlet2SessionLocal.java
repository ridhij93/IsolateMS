...
public class PingServlet2SessionLocal extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) {
        String uri = MicroserviceApplication.projectUri + "/ms5/pingservlet2sessionlocal/dopost?callerId=" + this.id + "&reqId=req.id&resId=res.id";
        ResponseEntity<Void> resultTemp = new RestTemplate().getForEntity(uri, void.class);
    }

    @Override
    public void doGet(HttpServletRequest req, HttpServletResponse res) {
        String uri = MicroserviceApplication.projectUri + "/ms5/pingservlet2sessionlocal/doget?callerId=" + this.id + "&reqId=req.id&resId=res.id";
        ResponseEntity<Void> resultTemp = new RestTemplate().getForEntity(uri, void.class);
    }
    ...
    public void init(ServletConfig config) {
        String uri = MicroserviceApplication.projectUri + "/ms5/pingservlet2sessionlocal/init?callerId=" + this.id + "&configId=config.id";
        ResponseEntity<Void> resultTemp = new RestTemplate().getForEntity(uri, void.class);
    }
    ...
    public void setTradeSLSBLocal(TradeSLSBLocal tradeSLSBLocal) {
        return;
    }

    public TradeSLSBLocal getTradeSLSBLocal() {
        return (TradeSLSBLocal) null;
    }

    public int id = 0;

    public static PingServlet2SessionLocal getObject(int id) {
        PingServlet2SessionLocal obj = (PingServlet2SessionLocal) new Object();
        obj.id = id;
        return obj;
    }
}
