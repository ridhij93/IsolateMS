...
public class QuoteDataBeanServer implements Serializable {
    ...
    public QuoteDataBeanServer() {
    }

    public QuoteDataBeanServer(String symbol, String companyName, double volume, BigDecimal price, BigDecimal open, BigDecimal low, BigDecimal high, double change) {
        setSymbol(symbol);
    ...
    public QuoteDataBeanServer(String symbol) {
        setSymbol(symbol);
    }
    ...
    public boolean equals(Object object) {
        ...
        if (this.symbol != other.getSymbol() && (this.symbol == null || !this.symbol.equals(other.getSymbol()))) {
            return false;
        }
        return true;
    }
