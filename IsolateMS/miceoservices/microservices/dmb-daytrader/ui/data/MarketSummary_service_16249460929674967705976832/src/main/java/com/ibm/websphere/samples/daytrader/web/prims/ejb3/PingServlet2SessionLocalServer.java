...
public class PingServlet2SessionLocalServer extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        output.append("<html><head><title>PingServlet2SessionLocal</title></head>" + "<body><HR><FONT size=\"+2\" color=\"#000066\">PingServlet2SessionLocal<BR></FONT>" + "<FONT size=\"-1\" color=\"#000066\">" + "Tests the basis path from a Servlet to a Session Bean.");
        try {
            try {
    ...
    public static void setInitTime(String initTime) {
        PingServlet2SessionLocalServer.initTime = initTime;
    }
    ...
    public static void setHitCount(int hitCount) {
        PingServlet2SessionLocalServer.hitCount = hitCount;
    }
    ...
    public void setTradeSLSBLocal(TradeSLSBLocal tradeSLSBLocal) {
        this.tradeSLSBLocal = tradeSLSBLocal;
    }

    public TradeSLSBLocal getTradeSLSBLocal() {
        return tradeSLSBLocal;
    }
}
