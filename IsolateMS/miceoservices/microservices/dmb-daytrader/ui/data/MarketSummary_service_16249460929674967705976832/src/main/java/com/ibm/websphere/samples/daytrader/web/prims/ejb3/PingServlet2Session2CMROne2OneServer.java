...
public class PingServlet2Session2CMROne2OneServer extends HttpServlet {
    ...
    public static void setInitTime(String initTime) {
        PingServlet2Session2CMROne2OneServer.initTime = initTime;
    }
    ...
    public static void setHitCount(int hitCount) {
        PingServlet2Session2CMROne2OneServer.hitCount = hitCount;
    }
