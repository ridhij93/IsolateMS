...
public class TradeConfigServletServer extends HttpServlet {
    ...
    void doConfigDisplay(HttpServletRequest req, HttpServletResponse resp, String results) throws Exception {
        ...
        getServletConfig().getServletContext().getRequestDispatcher(TradeConfig.getPage(TradeConfig.getCONFIG_PAGE())).include(req, resp);
    }
    ...
    void doResetTrade(HttpServletRequest req, HttpServletResponse resp, String results) throws Exception {
        ...
        getServletConfig().getServletContext().getRequestDispatcher(TradeConfig.getPage(TradeConfig.getSTATS_PAGE())).include(req, resp);
    }
    ...
    void doConfigUpdate(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        if (runTimeModeStr != null) {
            try {
                ...
                if (// Input validation
                (i >= 0) && (i < TradeConfig.getRunTimeModeNames().length))
