...
public class PingJDBCRead2JSPWrapper {
    ...
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingJDBCRead2JSPServer callerObj = idObjMap.get(callerId);
    ...
    public static HashMap<Integer, PingJDBCRead2JSPServer> idObjMap = new HashMap<>();

    @RequestMapping(method = RequestMethod.GET, value = "pingjdbcread2jsp")
    public  @ResponseBody int PingJDBCRead2JSP() {
        PingJDBCRead2JSPServer newServerObj = new PingJDBCRead2JSPServer();
