...
public class PingSession3Server extends HttpServlet {
    ...
    public static void setNUM_OBJECTS(int NUM_OBJECTS) {
        PingSession3Server.NUM_OBJECTS = NUM_OBJECTS;
    }
    ...
    public static void setInitTime(String initTime) {
        PingSession3Server.initTime = initTime;
    }
    ...
    public static void setHitCount(int hitCount) {
        PingSession3Server.hitCount = hitCount;
    }
