...
public class PingServlet2Session2EntityCollectionServer extends HttpServlet {
    ...
    public static void setInitTime(String initTime) {
        PingServlet2Session2EntityCollectionServer.initTime = initTime;
    }
    ...
    public static void setHitCount(int hitCount) {
        PingServlet2Session2EntityCollectionServer.hitCount = hitCount;
    }
