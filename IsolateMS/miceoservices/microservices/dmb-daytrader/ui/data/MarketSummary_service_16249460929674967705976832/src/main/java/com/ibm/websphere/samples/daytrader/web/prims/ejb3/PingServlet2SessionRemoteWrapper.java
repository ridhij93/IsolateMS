...
public class PingServlet2SessionRemoteWrapper {
    ...
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingServlet2SessionRemoteServer callerObj = idObjMap.get(callerId);
    ...
    public static HashMap<Integer, PingServlet2SessionRemoteServer> idObjMap = new HashMap<>();

    @RequestMapping(method = RequestMethod.GET, value = "pingservlet2sessionremote")
    public  @ResponseBody int PingServlet2SessionRemote() {
        PingServlet2SessionRemoteServer newServerObj = new PingServlet2SessionRemoteServer();
