...
public class PingServlet2Session2EntityServer extends HttpServlet {
    ...
    public static void setInitTime(String initTime) {
        PingServlet2Session2EntityServer.initTime = initTime;
    }
    ...
    public static void setHitCount(int hitCount) {
        PingServlet2Session2EntityServer.hitCount = hitCount;
    }
