...
public class MarketSummaryDataBeanServer implements Serializable {
    ...
    public MarketSummaryDataBeanServer() {
    }

    public MarketSummaryDataBeanServer(// , Collection topVolume
