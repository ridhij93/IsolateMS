...
public class PingServlet2DBWrapper {
    ...
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingServlet2DBServer callerObj = idObjMap.get(callerId);
    ...
    public static HashMap<Integer, PingServlet2DBServer> idObjMap = new HashMap<>();

    @RequestMapping(method = RequestMethod.GET, value = "pingservlet2db")
    public  @ResponseBody int PingServlet2DB() {
        PingServlet2DBServer newServerObj = new PingServlet2DBServer();
