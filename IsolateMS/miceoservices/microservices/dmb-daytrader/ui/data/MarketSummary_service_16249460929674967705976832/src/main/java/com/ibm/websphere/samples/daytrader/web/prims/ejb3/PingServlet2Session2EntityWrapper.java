...
public class PingServlet2Session2EntityWrapper {
    ...
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingServlet2Session2EntityServer callerObj = idObjMap.get(callerId);
    ...
    public static HashMap<Integer, PingServlet2Session2EntityServer> idObjMap = new HashMap<>();

    @RequestMapping(method = RequestMethod.GET, value = "pingservlet2session2entity")
    public  @ResponseBody int PingServlet2Session2Entity() {
        PingServlet2Session2EntityServer newServerObj = new PingServlet2Session2EntityServer();
