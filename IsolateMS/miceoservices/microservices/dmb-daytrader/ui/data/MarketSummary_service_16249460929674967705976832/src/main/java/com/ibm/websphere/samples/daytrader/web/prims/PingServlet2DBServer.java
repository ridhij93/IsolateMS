...
public class PingServlet2DBServer extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            trade.getConnPublic();
            output.append("<html><head><title>PingServlet2DB.</title></head>" + "<body><HR><FONT size=\"+2\" color=\"#000066\">PingServlet2DB:</FONT><HR><FONT size=\"-1\" color=\"#000066\">Init time : " + initTime);
            hitCount++;
    ...
    public static void setInitTime(String initTime) {
        PingServlet2DBServer.initTime = initTime;
    }
    ...
    public static void setHitCount(int hitCount) {
        PingServlet2DBServer.hitCount = hitCount;
    }
