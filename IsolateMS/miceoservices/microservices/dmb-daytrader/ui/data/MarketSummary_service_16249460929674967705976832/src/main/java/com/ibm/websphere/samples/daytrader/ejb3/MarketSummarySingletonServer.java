...
@Singleton
public class MarketSummarySingletonServer {
    ...
    private void updateMarketSummary() {
        ...
        BigDecimal TSIA = FinancialUtils.getZERO();
        BigDecimal openTSIA = FinancialUtils.getZERO();
        ...
        if (quoteArray.length > 5) {
            ...
            TSIA = TSIA.divide(new BigDecimal(quoteArray.length), FinancialUtils.getROUND());
            openTSIA = openTSIA.divide(new BigDecimal(quoteArray.length), FinancialUtils.getROUND());
        }
