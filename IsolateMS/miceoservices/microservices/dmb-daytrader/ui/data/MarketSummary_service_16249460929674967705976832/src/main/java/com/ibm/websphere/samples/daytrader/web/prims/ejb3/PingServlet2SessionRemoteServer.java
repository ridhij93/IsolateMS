...
public class PingServlet2SessionRemoteServer extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        output.append("<html><head><title>PingServlet2SessionRemote</title></head>" + "<body><HR><FONT size=\"+2\" color=\"#000066\">PingServlet2SessionRemote<BR></FONT>" + "<FONT size=\"-1\" color=\"#000066\">" + "Tests the basis path from a Servlet to a Session Bean.");
        try {
            try {
    ...
    public static void setInitTime(String initTime) {
        PingServlet2SessionRemoteServer.initTime = initTime;
    }
    ...
    public static void setHitCount(int hitCount) {
        PingServlet2SessionRemoteServer.hitCount = hitCount;
    }
    ...
    public void setTradeSLSBRemote(TradeSLSBRemote tradeSLSBRemote) {
        this.tradeSLSBRemote = tradeSLSBRemote;
    }

    public TradeSLSBRemote getTradeSLSBRemote() {
        return tradeSLSBRemote;
    }
}
