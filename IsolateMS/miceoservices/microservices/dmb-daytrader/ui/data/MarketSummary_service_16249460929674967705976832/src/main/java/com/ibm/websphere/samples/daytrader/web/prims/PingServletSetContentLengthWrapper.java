...
public class PingServletSetContentLengthWrapper {
    ...
    public @ResponseBody ResponseEntity<Void> doPost(@RequestParam int callerId, @RequestParam int reqId, @RequestParam int resId) {
        try {
            PingServletSetContentLengthServer callerObj = idObjMap.get(callerId);
    ...
    public static HashMap<Integer, PingServletSetContentLengthServer> idObjMap = new HashMap<>();

    @RequestMapping(method = RequestMethod.GET, value = "pingservletsetcontentlength")
    public  @ResponseBody int PingServletSetContentLength() {
        PingServletSetContentLengthServer newServerObj = new PingServletSetContentLengthServer();
