...
public class PingServlet2Session2CMROne2ManyServer extends HttpServlet {
    ...
    public static void setInitTime(String initTime) {
        PingServlet2Session2CMROne2ManyServer.initTime = initTime;
    }
    ...
    public static void setHitCount(int hitCount) {
        PingServlet2Session2CMROne2ManyServer.hitCount = hitCount;
    }
