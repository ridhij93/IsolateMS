...
public class PingServlet31AsyncReadServer extends HttpServlet {
    ...
    class ReadListenerImpl implements ReadListener {
        ...
        public void onAllDataRead() throws IOException {
            ...
            output.println("<html><head><title>Ping Servlet 3.1 Async</title></head>" + "<body><hr/><br/><font size=\"+2\" color=\"#000066\">Ping Servlet 3.1 AsyncRead</font>" + "<br/><font size=\"+1\" color=\"#000066\">Init time : " + initTime + "</font><br/><br/><b>Hit Count: " + ++hitCount + "</b><br/>Data Received: " + sb.toString() + "</body></html>");
            ac.complete();
        }
    ...
    public static void setInitTime(String initTime) {
        PingServlet31AsyncReadServer.initTime = initTime;
    }
    ...
    public static void setHitCount(int hitCount) {
        PingServlet31AsyncReadServer.hitCount = hitCount;
    }
