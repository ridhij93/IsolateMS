...
public class AccountDataJSFWrapper {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "toggleshowallrows")
    public @ResponseBody ResponseEntity<Void> toggleShowAllRows(@RequestParam int callerId) {
        AccountDataJSFServer callerObj = idObjMap.get(callerId);
    ...
    @RequestMapping(method = RequestMethod.GET, value = "accountdatajsf")
