 ...
 */
public class TradeBuildDBServer {

    /**
     * Populate a Trade DB using standard out as a log
     */
    public TradeBuildDBServer() throws Exception {
     ...
     */
    public TradeBuildDBServer(java.io.PrintWriter out, InputStream ddlFile) throws Exception {
            ...
            try {
                ...
                if (accountData != null) {
                    ...
                    for (int j = 0; j < holdings; j++) {
                        ...
                        tradeDirect.buy(userID, symbol, quantity, TradeConfig.getOrderProcessingMode());
                    }
                    // end-for
                    if (i % 50 == 0) {
