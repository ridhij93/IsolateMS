...
@Named("tradeconfig")
@RequestScoped
public class TradeConfigJSFServer {
    ...
    public String populateDatabase() {
        ...
        result = "TradeBuildDB: **** DayTrader Database Built - " + TradeConfig.getMAX_USERS() + " users created, " + TradeConfig.getMAX_QUOTES() + " quotes created. ****<br/>";
    ...
    public void setFacesExternalContext(ExternalContext facesExternalContext) {
        this.facesExternalContext = facesExternalContext;
    }

    public ExternalContext getFacesExternalContext() {
        return facesExternalContext;
    }
