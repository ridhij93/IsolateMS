...
public class PingSession1Server extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html><head><title>HTTP Session Key Test</title></head><body><HR><BR><FONT size=\"+2\" color=\"#000066\">HTTP Session Test 1: Session Key<BR></FONT><FONT size=\"+1\" color=\"#000066\">Init time: " + initTime + "</FONT><BR><BR>");
            hitCount++;
    ...
    public static void setCount(int count) {
        PingSession1Server.count = count;
    }
    ...
    public static void setInitTime(String initTime) {
        PingSession1Server.initTime = initTime;
    }
    ...
    public static void setHitCount(int hitCount) {
        PingSession1Server.hitCount = hitCount;
    }
