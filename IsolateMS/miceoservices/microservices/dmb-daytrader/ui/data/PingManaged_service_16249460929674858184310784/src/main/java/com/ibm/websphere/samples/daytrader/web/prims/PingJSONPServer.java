...
public class PingJSONPServer extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        try {
            ...
            out.println("<html><head><title>Ping JSONP</title></head>" + "<body><HR><BR><FONT size=\"+2\" color=\"#000066\">Ping JSONP</FONT><BR>Generated JSON: " + generatedJSON + "<br>Parsed JSON: " + parsedJSON + "</body></html>");
        } catch (Exception e) {
    ...
    public static void setInitTime(String initTime) {
        PingJSONPServer.initTime = initTime;
    }
    ...
    public static void setHitCount(int hitCount) {
        PingJSONPServer.hitCount = hitCount;
    }
