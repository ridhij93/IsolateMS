...
public class PingServletCDIBeanManagerViaCDICurrentWrapper {
    ...
    protected @ResponseBody ResponseEntity<Void> doGet(@RequestParam int callerId, @RequestParam int requestId, @RequestParam int responseId) {
        try {
            PingServletCDIBeanManagerViaCDICurrentServer callerObj = idObjMap.get(callerId);
    ...
    public static HashMap<Integer, PingServletCDIBeanManagerViaCDICurrentServer> idObjMap = new HashMap<>();

    @RequestMapping(method = RequestMethod.GET, value = "pingservletcdibeanmanagerviacdicurrent")
    public  @ResponseBody int PingServletCDIBeanManagerViaCDICurrent() {
        PingServletCDIBeanManagerViaCDICurrentServer newServerObj = new PingServletCDIBeanManagerViaCDICurrentServer();
