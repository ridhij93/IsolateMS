...
public class PingServletCDIBeanManagerViaJNDIWrapper {
    ...
    protected @ResponseBody ResponseEntity<Void> doGet(@RequestParam int callerId, @RequestParam int requestId, @RequestParam int responseId) {
        try {
            PingServletCDIBeanManagerViaJNDIServer callerObj = idObjMap.get(callerId);
    ...
    public static HashMap<Integer, PingServletCDIBeanManagerViaJNDIServer> idObjMap = new HashMap<>();

    @RequestMapping(method = RequestMethod.GET, value = "pingservletcdibeanmanagerviajndi")
    public  @ResponseBody int PingServletCDIBeanManagerViaJNDI() {
        PingServletCDIBeanManagerViaJNDIServer newServerObj = new PingServletCDIBeanManagerViaJNDIServer();
