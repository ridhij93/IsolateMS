...
public class PingManagedThread extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) {
        String uri = MicroserviceApplication.projectUri + "/ms4/pingmanagedthread/dopost?callerId=" + this.id + "&reqId=req.id&resId=res.id";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) {
        String uri = MicroserviceApplication.projectUri + "/ms4/pingmanagedthread/doget?callerId=" + this.id + "&reqId=req.id&resId=res.id";
        ResponseEntity<Void> resultTemp = new RestTemplate().getForEntity(uri, void.class);
    }
    ...
    public void init(ServletConfig config) {
        String uri = MicroserviceApplication.projectUri + "/ms4/pingmanagedthread/init?callerId=" + this.id + "&configId=config.id";
        ResponseEntity<Void> resultTemp = new RestTemplate().getForEntity(uri, void.class);
    }
    ...
    public static PingManagedThread getObject(int id) {
        PingManagedThread obj = (PingManagedThread) new Object();
        obj.id = id;
        return obj;
    }
}
