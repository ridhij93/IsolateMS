...
public class PingManagedExecutor extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) {
        String uri = MicroserviceApplication.projectUri + "/ms4/pingmanagedexecutor/dopost?callerId=" + this.id + "&reqId=req.id&resId=res.id";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) {
        String uri = MicroserviceApplication.projectUri + "/ms4/pingmanagedexecutor/doget?callerId=" + this.id + "&reqId=req.id&resId=res.id";
        ResponseEntity<Void> resultTemp = new RestTemplate().getForEntity(uri, void.class);
    }
    ...
    public void init(ServletConfig config) {
        String uri = MicroserviceApplication.projectUri + "/ms4/pingmanagedexecutor/init?callerId=" + this.id + "&configId=config.id";
        ResponseEntity<Void> resultTemp = new RestTemplate().getForEntity(uri, void.class);
    }
    ...
    public ManagedExecutorService getMes() {
        return (ManagedExecutorService) null;
    }

    public int id = 0;

    public static PingManagedExecutor getObject(int id) {
        PingManagedExecutor obj = (PingManagedExecutor) new Object();
        obj.id = id;
        return obj;
    }
}
