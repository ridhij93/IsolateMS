 ...
 */
public class MDBStatsServer extends java.util.HashMap<String, TimerStat> {
    ...
    public static void setMdbStats(MDBStats mdbStats) {
        MDBStatsServer.mdbStats = mdbStats;
    }

    public static MDBStats getMdbStats() {
        return mdbStats;
    }
}
