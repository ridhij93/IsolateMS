...
public class LoginValidatorServer implements Validator {
    ...
    public static void setLoginRegex(String loginRegex) {
        LoginValidatorServer.loginRegex = loginRegex;
    }
    ...
    public static void setPattern(Pattern pattern) {
        LoginValidatorServer.pattern = pattern;
    }
    ...
    public static void setMatcher(Matcher matcher) {
        LoginValidatorServer.matcher = matcher;
    }
