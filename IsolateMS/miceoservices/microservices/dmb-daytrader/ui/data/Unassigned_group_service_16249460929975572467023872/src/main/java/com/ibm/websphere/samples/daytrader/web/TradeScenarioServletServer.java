...
public class TradeScenarioServletServer extends HttpServlet {
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (userID == null) {
            ...
            // users.
            action = TradeConfig.getScenarioAction(userID.startsWith(TradeConfig.getNewUserPrefix()));
        }
        switch(action) {
            case // quote
            'q':
             ...
             */
                if (userID.startsWith(TradeConfig.getNewUserPrefix()) == false) {
    ...
    public static String getTasPathPrefix() {
        return tasPathPrefix;
    }
}
