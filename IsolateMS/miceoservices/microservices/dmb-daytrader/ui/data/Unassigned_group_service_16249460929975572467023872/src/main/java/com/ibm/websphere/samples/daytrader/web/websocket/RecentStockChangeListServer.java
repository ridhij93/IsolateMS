 ...
 */
public class RecentStockChangeListServer {
    ...
    public static void setStockChanges(List<Message> stockChanges) {
        RecentStockChangeListServer.stockChanges = stockChanges;
    }

    public static List<Message> getStockChanges() {
        return stockChanges;
    }
}
