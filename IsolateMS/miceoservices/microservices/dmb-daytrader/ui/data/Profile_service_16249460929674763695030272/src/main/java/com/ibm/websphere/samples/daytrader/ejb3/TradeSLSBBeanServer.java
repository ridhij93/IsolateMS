...
public class TradeSLSBBeanServer implements TradeSLSBRemote, TradeSLSBLocal {
    ...
    */
    ...
    private OrderDataBean createOrder(AccountDataBean account, QuoteDataBean quote, HoldingDataBean holding, String orderType, double quantity) {
        ...
        try {
            order = new OrderDataBean(orderType, "open", new Timestamp(System.currentTimeMillis()), null, quantity, quote.getPrice().setScale(FinancialUtils.getSCALE(), FinancialUtils.getROUND()), TradeConfig.getOrderFee(orderType), account, quote, holding);
    ...
    public void setTradeStreamerTopic(Topic tradeStreamerTopic) {
        this.tradeStreamerTopic = tradeStreamerTopic;
    }
    ...
    public void setTradeBrokerQueue(Queue tradeBrokerQueue) {
        this.tradeBrokerQueue = tradeBrokerQueue;
    }
    ...
    public void setMarketSummarySingleton(MarketSummarySingleton marketSummarySingleton) {
        this.marketSummarySingleton = marketSummarySingleton;
    }

    public MarketSummarySingleton getMarketSummarySingleton() {
        return marketSummarySingleton;
    }
}
