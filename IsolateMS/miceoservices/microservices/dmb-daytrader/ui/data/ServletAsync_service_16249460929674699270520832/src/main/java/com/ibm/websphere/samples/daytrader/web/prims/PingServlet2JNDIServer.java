...
public class PingServlet2JNDIServer extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            output.append("<html><head><title>Ping JNDI -- lookup of JDBC DataSource</title></head>" + "<body><HR><FONT size=\"+2\" color=\"#000066\">Ping JNDI -- lookup of JDBC DataSource</FONT><HR><FONT size=\"-1\" color=\"#000066\">Init time : " + initTime);
            hitCount++;
    ...
    public static void setInitTime(String initTime) {
        PingServlet2JNDIServer.initTime = initTime;
    }
    ...
    public static void setHitCount(int hitCount) {
        PingServlet2JNDIServer.hitCount = hitCount;
    }
