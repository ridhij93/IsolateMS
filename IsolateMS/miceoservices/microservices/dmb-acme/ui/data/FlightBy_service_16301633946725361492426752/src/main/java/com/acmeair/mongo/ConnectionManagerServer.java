...
public class ConnectionManagerServer implements MongoConstants {
    ...
    private ConnectionManagerServer() {
        ...
        try {
            ...
            if (isManual) {
                if (mongoUser != null) {
                    MongoCredential credential = MongoCredential.createCredential(mongoUser, dbname, mongoPassword.toCharArray());
    ...
    public static void setConnectionManager(AtomicReference<ConnectionManager> connectionManager) {
        ConnectionManagerServer.connectionManager = connectionManager;
    }
