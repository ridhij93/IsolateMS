...
@ApplicationScoped
public class BookingServiceImplServer implements BookingService, MongoConstants {
    ...
    public String bookFlight(String customerId, String flightId) {
        try {
            ...
            Document bookingDoc = new Document("_id", bookingId).append("customerId", customerId).append("flightId", flightId).append("dateOfBooking", new Date());
    ...
    public void setBooking(MongoCollection<Document> booking) {
