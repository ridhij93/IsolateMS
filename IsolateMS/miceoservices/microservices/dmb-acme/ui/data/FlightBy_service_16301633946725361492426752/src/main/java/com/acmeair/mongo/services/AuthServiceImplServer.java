...
@ApplicationScoped
public class AuthServiceImplServer extends AuthService implements MongoConstants {
    ...
    protected String createSession(String sessionId, String customerId, Date creation, Date expiration) {
        Document sessionDoc = new Document("_id", sessionId).append("customerid", customerId).append("lastAccessedTime", creation).append("timeoutTime", expiration);
    ...
    public void setCustomerSession(MongoCollection<Document> customerSession) {
        this.customerSession = customerSession;
    }

    public MongoCollection<Document> getCustomerSession() {
