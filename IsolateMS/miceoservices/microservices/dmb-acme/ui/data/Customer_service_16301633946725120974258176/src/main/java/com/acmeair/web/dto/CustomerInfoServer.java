...
public class CustomerInfoServer implements Serializable {
    ...
    public CustomerInfoServer() {
    }

    public CustomerInfoServer(String username, String password, String status, int total_miles, int miles_ytd, AddressInfo address, String phoneNumber, String phoneNumberType) {
        this._id = username;
    ...
    public String toString() {
        return "Customer [id=" + _id + ", password=" + password + ", status=" + status + ", total_miles=" + total_miles + ", miles_ytd=" + miles_ytd + ", address=" + address + ", phoneNumber=" + phoneNumber + ", phoneNumberType=" + phoneNumberType + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (_id == null) {
            ...
            return false;
        if (miles_ytd != other.getMiles_ytd())
            return false;
        if (password == null) {
        ...
        if (phoneNumber == null) {
            ...
            return false;
        if (phoneNumberType != other.getPhoneNumberType())
            return false;
        if (status != other.getStatus())
            return false;
        if (total_miles != other.getTotal_miles())
            return false;
        return true;
    }
