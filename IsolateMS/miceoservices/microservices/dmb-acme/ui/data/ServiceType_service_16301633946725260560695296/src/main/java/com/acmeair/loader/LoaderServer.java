...
public class LoaderServer {
	...
	*/
    public void setFlightLoader(FlightLoader flightLoader) {
    ...
    public void setBookingLoader(BookingLoader bookingLoader) {
        this.bookingLoader = bookingLoader;
    }

    public BookingLoader getBookingLoader() {
        return bookingLoader;
    }

    public static void setREPOSITORY_LOOKUP_KEY(String REPOSITORY_LOOKUP_KEY) {
        LoaderServer.REPOSITORY_LOOKUP_KEY = REPOSITORY_LOOKUP_KEY;
    }

    public static String getREPOSITORY_LOOKUP_KEY() {
        return REPOSITORY_LOOKUP_KEY;
    }

    public static void setLogger(Logger logger) {
        LoaderServer.logger = logger;
    }
